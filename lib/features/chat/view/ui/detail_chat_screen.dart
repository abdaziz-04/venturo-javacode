...
class DetailChastScreen extends StatefulWidget {
  const DetailChastScreen({super.key});

  @override
  State<DetailChastScreen> createState() => _DetailChastScreenState();
}

class _DetailChastScreenState extends State<DetailChastScreen> {
