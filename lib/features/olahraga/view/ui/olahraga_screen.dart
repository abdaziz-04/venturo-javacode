...
import 'package:diet_nyaman_app/features/olahraga/constants/olahraga_assets_constant.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class OlahragaScreen extends StatelessWidget {
  OlahragaScreen({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Get.toNamed(Routes.olahragaDetailRoute);
                  },
